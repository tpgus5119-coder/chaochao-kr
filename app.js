...
const UIVI = {
  ...
  '과정을 불러오는 중…': 'Đang tải khóa học…',
  '되돌릴 수 없습니다. 정말 지울까요?': 'Không thể hoàn tác. Bạn có chắc muốn xóa không?',
  '레슨': 'Bài học',
  '말에 대한 말': 'Từ ngữ về từ ngữ',
  '모두 고르기': 'Chọn tất cả',
  '모두 풀기(해제)': 'Bỏ chọn tất cả',
  '아직 끝낸 레슨이 없습니다. 학습에서 한 레슨을 끝내면 여기에 나옵니다.':
    'Chưa hoàn thành bài học nào. Khi hoàn thành một bài học, nó sẽ hiện ở đây.',
  '오늘 공부하면 순위가 생깁니다': 'Học hôm nay để có thứ hạng',
  '일터에서는': 'Ở nơi làm việc thì',
  '풀고 싶은 레슨을 고르세요': 'Chọn bài học bạn muốn làm',
  '🔊 듣기': '🔊 Nghe',
  '🐢 느리게': '🐢 Chậm',
  '업종 ': 'Ngành ',
  '‹ 돌아가기': '‹ Quay lại',
